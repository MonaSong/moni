<template>
  <div class="popular-hot ">
    ...
    <div class="hot-container clearfix">
      <div v-for="(item, $index) in list" @mouseenter="_popverEnter(item)" @mouseleave="_popoverLeave(item)"  ref="hot-item">
          <div class="item" >
            ...
            <transition name="fade">
              <div class="popover clearfix" v-show="item.isPopover">
                ...
                <div class="popover-body clearfix">
                  <div class="item-des">
                    <p><strong>brief description ：</strong>{{item.data.des}}</p>
                  </div>
                  <div class="item-operator clearfix">
                    <div class="qrcode">
                        <img src="" alt="">
                        <p>andriod look at <span class="text-orange">welfare</span>look at</p>
                    </div>
              ...
              <transition name="fade">
                <div>
                  ...
                  <div class="modal-body-left" v-if="isShowGift">
                    ...
                    <div class="gift-item clearfix" v-for="giftItem in gift">
                      <div class="gift-left clearfix">
                        <div class="gift-date">To：{{giftItem.expiryDate}}</div>
                        <h4 class="title">{{giftItem.name}}</h4>
                        <div class="process-info">
                          over：<span class="process-bar"><b class="process-current" :style="{width: giftItem.surplus}"></b></span> <small>{{giftItem.surplus}}</small>
                        </div>
                  ...
                  <div class="modal-body-right">
                    ...
                    <div class="app-detail-info">size<strong>{{modalInfo.data.size}}</strong></div>
                    <div class="app-detail-info">classify<strong>{{modalInfo.data.size}}</strong></div>
                    <div class="app-detail-info">hot<strong>{{modalInfo.data.size}}</strong></div>
                    <div class="app-detail-info">version<strong>{{modalInfo.data.size}}</strong></div>
                    <div class="app-detail-info">update at<strong>{{modalInfo.data.size}}</strong></div>
